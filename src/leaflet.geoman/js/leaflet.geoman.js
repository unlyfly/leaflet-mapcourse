  ...
  var t = {
      ...
      4102: (t, e) => {
        ...
        function s(t, e, n) {
          return (
            void 0 === n && (n = {}),
            i({ type: "MultiLineString", coordinates: t }, e, n)
          );
        }
        function l(t, e, n) {
          return (
            void 0 === n && (n = {}),
            i({ type: "MultiPoint", coordinates: t }, e, n)
          );
        }
        function h(t, e, n) {
          return (
            void 0 === n && (n = {}),
            i({ type: "MultiPolygon", coordinates: t }, e, n)
          );
        }
        function u(t, i) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          ...
          (e.geometryCollection = function (t, e, n) {
            return (
              void 0 === n && (n = {}),
              i({ type: "GeometryCollection", geometries: t }, e, n)
            );
          }),
      ...
      1540: (t, e, i) => {
        ...
        function r(t, e, i) {
          if (null !== t)
            for (
              ...
              l = (c =
                !!(u = g ? t.features[y].geometry : _ ? t.geometry : t) &&
              ...
              for (var v = 0; v < l; v++) {
                ...
                if (null !== (s = c ? u.geometries[v] : u)) {
                  ...
                  switch (
                    ((p =
                      !i || ("Polygon" !== k && "MultiPolygon" !== k) ? 0 : 1),
                    k)
                  ) {
                    case null:
                      break;
                    ...
                    case "GeometryCollection":
                      for (n = 0; n < s.geometries.length; n++)
                        if (!1 === r(s.geometries[n], e, i)) return !1;
                      break;
                    default:
        ...
        function o(t, e) {
          if ("Feature" === t.type) e(t, 0);
            ...
            for (
              var i = 0;
              i < t.features.length && !1 !== e(t.features[i], i);
              i++
            );
        }
        function s(t, e) {
          ...
          for (i = 0; i < g; i++) {
            for (
              s = d ? t.features[i].geometry : f ? t.geometry : t,
                ...
                o = (l = !!s && "GeometryCollection" === s.type)
                  ? s.geometries.length
                  : 1,
                r = 0;
              r < o;
                ...
                switch (a.type) {
                  ...
                  case "GeometryCollection":
                    for (n = 0; n < a.geometries.length; n++)
                      if (!1 === e(a.geometries[n], p, h, u, c)) return !1;
                    break;
                  default:
                    throw new Error("Unknown Geometry Type");
                }
        ...
        function l(t, e) {
          s(t, function (t, i, r, a, o) {
            ...
            switch (l) {
              ...
              case "Polygon":
                return (
                  !1 !== e(n.feature(t, r, { bbox: a, id: o }), i, 0) && void 0
                );
            }
            switch (l) {
              case "MultiPoint":
                ...
                return (
                  !1 !==
                    r(t, function (r, s, p, d, f) {
                      if (l === undefined || i > h || d > u || f > c)
                        return (l = r), (h = i), (u = d), (c = f), void (o = 0);
              ...
              switch (a) {
                ...
                case "Polygon":
                  for (var s = 0; s < o.length; s++)
                    if (!1 === e(n.lineString(o[s], t.properties), i, r, s))
                      return !1;
              }
            }
          });
            ...
            switch (i.type) {
              ...
              case "MultiPolygon":
                return (
                  a < 0 && (a = h.length + a),
                  o < 0 && (o = h[a].length + o),
                  s < 0 && (s = h[a][o].length - s - 1),
                  n.lineString([h[a][o][s], h[a][o][s + 1]], l, e)
                );
            }
            throw new Error("geojson is invalid");
          }),
          ...
          (e.segmentReduce = function (t, e, i) {
            ...
            return (
              h(t, function (t, a, o, s, l) {
                (n = !1 === r && i === undefined ? t : e(n, t, a, o, s, l)),
                  (r = !0);
              }),
              n
            );
      ...
      5975: (t, e, i) => {
          ...
          handleLayerAdditionInGlobalEditMode: function () {
            ...
            for (var e in ((this._addedLayers = {}), t)) {
              ...
              this._isRelevantForEdit(i) &&
                this.globalEditModeEnabled() &&
                i.pm.enable(y({}, this.globalOptions));
            }
          },
        ...
        const k = {
          ...
          reinitGlobalDragMode: function () {
            ...
            for (var e in ((this._addedLayersDrag = {}), t)) {
              var i = t[e];
              this._isRelevantForDrag(i) &&
                this.globalDragModeEnabled() &&
                i.pm.enableLayerDrag();
            }
          },
          ...
          enableGlobalRemovalMode: function () {
            ...
            (this._globalRemovalModeEnabled = !0),
              this.map.eachLayer(function (e) {
                t._isRelevantForRemoval(e) &&
                  (e.pm.disable(), e.on("click", t.removeLayer, t));
              }),
        ...
        const x = {
          ...
          _reinitGlobalRotateMode: function (t) {
            var e = t.layer;
            this._isRelevantForRotate(e) &&
              this.globalRotateModeEnabled() &&
              (this.disableGlobalRotateMode(), this.enableGlobalRotateMode());
          },
        ...
        var E = {
          ...
          _fireLangChange: function (t, e, i, n) {
            ...
            this.__fire(
              this.map,
              "pm:langchange",
              { oldLang: t, activeLang: e, fallback: i, translations: n },
              r,
              a
            );
          },
        ...
        const O = {
          ...
          _onBlur: function (t) {
            t.altKey = !1;
            var e = { event: t, eventType: t.type, focusOn: "document" };
          ...
          isShiftKeyPressed: function () {
            var t;
            return null === (t = this._lastEvents.current) || void 0 === t
              ? void 0
              : t.event.shiftKey;
          },
            ...
            (n = Math.cos(2 * v + C)),
              ...
              (C =
                ...
                w *
                  ...
                  (n +
                    (w / 4) *
                      ((a = Math.cos(C)) * (2 * n * n - 1) -
                        (w / 6) * n * (4 * r * r - 3) * (4 * n * n - 3))));
          }
          var E = y * r - m * a * g,
            S = Math.atan2(
              y * a + m * r * g,
              (1 - l) * Math.sqrt(b * b + E * E)
            ),
            O = (l / 16) * k * (4 + l * (4 - 3 * k)),
            D =
              h +
              (180 *
                (Math.atan2(r * f, m * a - y * r * g) -
                  (1 - O) *
                    l *
                    b *
                    (C + O * r * (n + O * a * (2 * n * n - 1))))) /
        ...
        function N(t, e, i, n) {
          for (
            ...
            if (o)
              (r = G(t, (360 * l) / i + n, e)), (a = L.latLng(r.lng, r.lat));
            else {
        ...
        function F(t, e) {
          ...
          for (var n, r = Object.keys(e), a = r.length - 1, o = {}; a >= 0; )
            (n = r[a]), (o[n.toLowerCase()] = e[n]), (a -= 1);
          function s(t) {
          ...
          return function (e, n) {
            ...
            if ("instanceofShape" === t) {
              if (
                ((r = s(e.layer).toLowerCase()),
                (a = s(n.layer).toLowerCase()),
                !r || !a)
              )
                return 0;
            } else {
        ...
        const H = L.Class.extend({
          ...
          setLang: function () {
            ...
            e && (_[t] = r()(_[i], e)),
              ...
              this._fireLangChange(n, t, i, _[t]);
          },
          ...
          setGlobalOptions: function (t) {
            ...
            this.map.pm.Draw.CircleMarker.enabled() &&
              !!this.map.pm.Draw.CircleMarker.options.editable !=
                !!i.editable &&
          ...
          _canvasTouchClick: function (t) {
            ...
            "touchstart" === t.type || "pointerdown" === t.type
              ...
              ? (e = "mouseup")
              : ("touchcancel" !== t.type && "pointercancel" !== t.type) ||
                (e = "mouseup"),
              e && K(this.map)._onClick(this._createMouseEvent(e, t));
          },
        ...
        const q = L.Control.extend({
          ...
          _makeButton: function (t) {
            var e = this,
              i =
                this.options.position.indexOf("right") > -1 ? "pos-right" : "",
              n = L.DomUtil.create(
                "div",
                "button-container  ".concat(i),
                this._container
              );
            ...
            var a = L.DomUtil.create(
                "div",
                "leaflet-pm-actions-container ".concat(i),
                n
              ),
              o = t.actions,
              s = {
            ...
            o.forEach(function (n) {
              ...
              var l = L.DomUtil.create(
                "a",
                "leaflet-pm-action ".concat(i, " action-").concat(o),
                a
              );
              if (
            ...
            if (this._container) {
              ...
              this._button.disabled
                ? (L.DomUtil.addClass(e, t),
                  ...
                  L.DomEvent.off(e, "click", this._triggerClick, this),
                  L.DomEvent.off(e, "click", this._onBtnClick, this))
                : (L.DomUtil.removeClass(e, t),
                  e.setAttribute("aria-disabled", "false"),
                  L.DomEvent.on(e, "click", this._triggerClick, this),
                  L.DomEvent.on(e, "click", this._onBtnClick, this));
            }
          },
        });
        function J(t, e) {
        ...
        const $ = L.Class.extend({
          ...
          addControls: function () {
            ...
            "undefined" != typeof t.editPolygon && (t.editMode = t.editPolygon),
              "undefined" != typeof t.deleteLayer &&
                (t.removalMode = t.deleteLayer),
            ...
            var t = this.getButtons(),
              e = {
                geomanIcons: {
                  ...
                  drawCircleMarker:
                    "control-icon leaflet-pm-icon-circle-marker",
          ...
          toggleButton: function (t, e) {
            ...
            return (
              ...
              i && this.triggerClickOnToggledButtons(this.buttons[t]),
          ...
          _defineButtons: function () {
            ...
            this._addButton("drawMarker", new L.Control.PMButton(e)),
              ...
              this._addButton("drawText", new L.Control.PMButton(p)),
            ...
            if (this.isVisible) {
              ...
              t))
                if (this.options[i] && -1 === e.indexOf(i)) {
                  ...
                  n || (n = "draw"),
                    t[i].setPosition(this._getBtnPosition(n)),
                    t[i].addTo(this.map);
                }
            }
          },
          ...
          copyDrawControl: function (t, e) {
            ...
            return (
              (e = Y(Y({}, this.buttons[i]._button), e)),
              { drawInstance: n, control: this.createCustomControl(e) }
            );
          },
          createCustomControl: function (t) {
            ...
            var n = {
              ...
              toggleStatus: !1,
              disableOtherButtons:
                null === (e = t.disableOtherButtons) || void 0 === e || e,
              disableByOtherButtons:
                null === (i = t.disableByOtherButtons) || void 0 === i || i,
              cssToggle: t.toggle,
              position: this.options.position,
              actions: t.actions || [],
              disabled: !!t.disabled,
        ...
        var et = {
          _initSnappableMarkers: function () {
            (this.options.snapDistance = this.options.snapDistance || 30),
              (this.options.snapSegment =
                this.options.snapSegment === undefined ||
                this.options.snapSegment),
          ...
          _handleSnapping: function (t) {
            ...
            if (
              (this._fireSnapDrag(s.marker, s),
              this._fireSnapDrag(this._layer, s),
              n.distance < o)
            ) {
              ...
              (l.lat === h.lat && l.lng === h.lng) ||
                ((e._snapLatLng = r),
                e._fireSnap(i, s),
                e._fireSnap(e._layer, s));
            } else
              this._snapLatLng &&
                (this._unsnap(s),
                (i._snapped = !1),
                (i._snapInfo = undefined),
                this._fireUnsnap(s.marker, s),
                this._fireUnsnap(this._layer, s));
            return !0;
          },
            ...
            n.off("pm:remove", this._handleSnapLayerRemoval, this),
              ...
              n.eachLayer(function (t) {
                if (
                  ...
                  if (
                    t.options.snapIgnore === undefined &&
                    ((!L.PM.optIn && !0 === t.options.pmIgnore) ||
                      (L.PM.optIn && !1 !== t.options.pmIgnore))
                  )
                    return;
          ...
          _calcClosestLayers: function (t, e) {
            ...
            e.forEach(function (e, o) {
              if (!e._parentCopy || e._parentCopy !== i._layer) {
                ...
                if (
                  ((s.distance = Math.floor(s.distance)), i.debugIndicatorLines)
                ) {
                  if (!i.debugIndicatorLines[o]) {
                    var l = L.polyline([], { color: "red", pmIgnore: !0 });
                    (l._pmTempLayer = !0), (i.debugIndicatorLines[o] = l);
                  }
                  i.debugIndicatorLines[o].setLatLngs([t, s.latlng]);
                }
                1 === n &&
                (a.distance === undefined || s.distance <= a.distance)
                  ? (s.distance < a.distance && (r = []),
                    ((a = s).layer = e),
                    r.push(a))
                  : 1 !== n && ((a = {}), ((a = s).layer = e), r.push(a));
              }
            }),
              1 !== n &&
          ...
          _calcLayerDistances: function (t, e) {
            ...
            if (n) {
              var o = e.getLatLng();
              return { latlng: Q({}, o), distance: this._getDistance(i, o, a) };
            }
          ...
          _calcLatLngDistances: function (t, e, i) {
            var n,
              ...
              l = function u(e) {
                e.forEach(function (l, h) {
                  if (Array.isArray(l)) u(l);
                  else if (o.options.snapSegment) {
                    var c,
                      p = l;
                    c = s
                      ? h + 1 === e.length
            ...
            if ((l(e), this.options.snapSegment)) {
              ...
              return { latlng: Q({}, h), segment: a, distance: r };
            }
            return { latlng: n, distance: r };
          },
        ...
        const nt = L.Class.extend({
          ...
          createNewDrawInstance: function (t, e) {
            ...
            if (!L.PM.Draw[i])
              throw new TypeError("There is no class L.PM.Draw.".concat(i));
            return (
          ...
          _isFirstLayer: function () {
            return (
              0 === (this._map || this._layer._map).pm.getGeomanLayers().length
            );
          },
        });
        nt.Marker = nt.extend({
          ...
          _syncHintMarker: function (t) {
            if (
              (this._hintMarker.setLatLng(t.latlng), this.options.snappable)
            ) {
              var e = t;
          ...
          setStyle: function () {
            var t, e;
            null !== (t = this.options.markerStyle) &&
              void 0 !== t &&
              t.icon &&
              (null === (e = this._hintMarker) ||
                void 0 === e ||
                e.setIcon(this.options.markerStyle.icon));
          },
        });
        var rt = 6371008.8,
          at = {
        ...
        function st(t, e, i) {
          ...
          if (!ft(t[0]) || !ft(t[1]))
            throw new Error("coordinates must contain numbers");
          return ot({ type: "Point", coordinates: t }, e, i);
        }
        function lt(t, e, i) {
          ...
          return ot({ type: "LineString", coordinates: t }, e, i);
        }
        function ht(t, e) {
          void 0 === e && (e = {});
          var i = { type: "FeatureCollection" };
                  ...
                  for (var r = i; r < e.length - 1; r++) {
                    if (t === e) {
                      ...
                      if (
                        0 === i &&
                        r === t.length - 2 &&
                        t[i][0] === t[t.length - 1][0] &&
                        t[i][1] === t[t.length - 1][1]
                      )
                        continue;
                    }
                    var a = _t(
        ...
        function Ot(t, e, i) {
          if (null !== t)
            for (
              ...
              s = (u =
                !!(h = f ? t.features[m].geometry : g ? t.geometry : t) &&
              ...
              for (var y = 0; y < s; y++) {
                ...
                if (null !== (o = u ? h.geometries[y] : h)) {
                  ...
                  switch (
                    ((c =
                      !i || ("Polygon" !== b && "MultiPolygon" !== b) ? 0 : 1),
                    b)
                  ) {
                    case null:
                      break;
                    ...
                    case "GeometryCollection":
                      for (n = 0; n < o.geometries.length; n++)
                        if (!1 === Ot(o.geometries[n], e, i)) return !1;
                      break;
                    default:
                      throw new Error("Unknown Geometry Type");
                  }
        ...
        function Rt(t, e) {
          Bt(t, function (t, i, n, r, a) {
            ...
            switch (s) {
              ...
              case "LineString":
              case "Polygon":
                return !1 !== e(ot(t, n, { bbox: r, id: a }), i, 0) && void 0;
            }
            switch (s) {
              case "MultiPoint":
                o = "Point";
            ...
            for (var l = 0; l < t.coordinates.length; l++) {
              ...
              if (!1 === e(ot({ type: o, coordinates: h }, n), i, l)) return !1;
            }
          });
        }
        (nt.Line = nt.extend({
          ...
          enable: function (t) {
            L.Util.setOptions(this, t),
              ...
              (this._layer = L.polyline(
                [],
                yt(yt({}, this.options.templineStyle), {}, { pmIgnore: !1 })
              )),
              ...
              this.options.tooltips &&
                this._hintMarker
                  .bindTooltip(I("tooltips.firstVertex"), {
                    permanent: !0,
                    offset: L.point(0, 10),
                    direction: "bottom",
                    opacity: 0.8,
          ...
          _handleSelfIntersection: function (t, e) {
            ...
            (this._doesSelfIntersect = n.features.length > 0),
          ...
          _createVertex: function (t) {
            if (
              ...
              var e = this._hintMarker.getLatLng(),
                ...
                n = i[i.length - 1];
              if (e.equals(i[0]) || (i.length > 0 && e.equals(n)))
                this._finishShape();
              else {
                ...
                this._setTooltipText(),
                  ...
                  this._fireVertexAdded(r, undefined, e, "Draw"),
          ...
          _removeLastVertex: function () {
            ...
            if (t.length <= 1) this.disable();
              ...
              (e = e.slice(0, a + 1)),
                ...
                this._syncHintLine(),
                this._setTooltipText(),
                this._fireVertexRemoved(i, n, "Draw"),
                this._change(this._layer.getLatLngs());
            }
          },
          ...
          _setTooltipText: function () {
            ...
            (t = I(
              this._layer.getLatLngs().flat().length <= 1
                ? "tooltips.continueLine"
                : "tooltips.finishLine"
            )),
              this._hintMarker.setTooltipContent(t);
          },
          _change: function (t) {
          ...
          setStyle: function () {
            ...
            null === (t = this._layer) ||
              void 0 === t ||
              t.setStyle(this.options.templineStyle),
              null === (e = this._hintline) ||
                void 0 === e ||
                e.setStyle(this.options.hintlineStyle);
          },
        })),
          (nt.Polygon = nt.Line.extend({
            ...
            _createMarker: function (t) {
              ...
              return (
                ...
                1 === this._layer.getLatLngs().flat().length
                  ? (e.on("click", this._finishShape, this),
                    (this._tempSnapLayerIndex =
                      this._otherSnapLayers.push(e) - 1),
                    this.options.snappable && this._cleanupSnapping())
                  : e.on("click", function () {
                      return 1;
                    }),
            ...
            _setTooltipText: function () {
              var t = "";
              (t = I(
                this._layer.getLatLngs().flat().length <= 2
                  ? "tooltips.continueLine"
                  : "tooltips.finishPoly"
              )),
                this._hintMarker.setTooltipContent(t);
          ...
          (nt.Rectangle = nt.extend({
            ...
            _finishShape: function (t) {
              ...
              if (
                ...
                if (this.options.rectangleAngle) {
                  var r = L.PM.Utils._getRotatedRectangle(
                    i,
                    e,
                    this.options.rectangleAngle || 0,
                    this._map
                  ...
                  n.setLatLngs(r),
                    n.pm && n.pm._setAngle(this.options.rectangleAngle || 0);
                }
            ...
            setStyle: function () {
              ...
              null === (t = this._layer) ||
                void 0 === t ||
                t.setStyle(this.options.pathOptions);
            },
          })),
          (nt.Circle = nt.extend({
            initialize: function (t) {
            ...
            enable: function (t) {
              L.Util.setOptions(this, t),
                ...
                (this._layerGroup._pmTempLayer = !0),
                this._layerGroup.addTo(this._map),
                (this._layer = L.circle(
                  this._map.getCenter(),
                  bt(bt({}, this.options.templineStyle), {}, { radius: 0 })
                )),
                this._setPane(this._layer, "layerPane"),
                (this._layer._pmTempLayer = !0),
            ...
            _syncCircleRadius: function () {
              ...
              (t =
                this._map.options.crs === L.CRS.Simple
                  ? this._map.distance(e, i)
                  : e.distanceTo(i)),
                this.options.minRadiusCircle && t < this.options.minRadiusCircle
                  ...
                  : this.options.maxRadiusCircle &&
                    t > this.options.maxRadiusCircle
            ...
            _syncHintMarker: function (t) {
              if (
                ...
                this._hintMarker.setLatLng(
                  this._getNewDestinationOfHintMarker()
                ),
            ...
            _finishShape: function (t) {
              if (
                ...
                (e =
                  this._map.options.crs === L.CRS.Simple
                    ? this._map.distance(i, n)
                    : i.distanceTo(n)),
                  this.options.minRadiusCircle &&
                  e < this.options.minRadiusCircle
                    ? (e = this.options.minRadiusCircle)
                    : this.options.maxRadiusCircle &&
                      e > this.options.maxRadiusCircle &&
                      (e = this.options.maxRadiusCircle);
                var r = bt(bt({}, this.options.pathOptions), {}, { radius: e }),
                  a = L.circle(i, r);
            ...
            _getNewDestinationOfHintMarker: function () {
              ...
              return (
                this.options.minRadiusCircle && i < this.options.minRadiusCircle
                  ? (t = z(this._map, e, t, this.options.minRadiusCircle))
                  : this.options.maxRadiusCircle &&
                    i > this.options.maxRadiusCircle &&
                    (t = z(this._map, e, t, this.options.maxRadiusCircle)),
                t
              );
            },
            _handleHintMarkerSnapping: function () {
              if (this._hintMarker._snapped) {
                ...
                this._layerGroup.hasLayer(this._centerMarker) &&
                  ((this.options.minRadiusCircle &&
                    i < this.options.minRadiusCircle) ||
                    (this.options.maxRadiusCircle &&
                      i > this.options.maxRadiusCircle)) &&
          ...
          (nt.CircleMarker = nt.Marker.extend({
            ...
            enable: function (t) {
              ...
              if (
                ...
                L.extend(i, this.options.templineStyle),
                  ...
                  (this._layerGroup._pmTempLayer = !0),
                  this._layerGroup.addTo(this._map),
                  (this._layer = L.circleMarker(this._map.getCenter(), i)),
                  this._setPane(this._layer, "layerPane"),
                  (this._layer._pmTempLayer = !0),
                  (this._centerMarker = L.marker(this._map.getCenter(), {
                    icon: L.divIcon({ className: "marker-icon" }),
              ...
              if (
                ...
                this.options.editable &&
                  ...
                  n < this.options.minRadiusCircleMarker
                    ? (n = this.options.minRadiusCircleMarker)
                    : this.options.maxRadiusCircleMarker &&
                      n > this.options.maxRadiusCircleMarker &&
                      (n = this.options.maxRadiusCircleMarker));
                var r = xt(xt({}, this.options.pathOptions), {}, { radius: n }),
            ...
            setStyle: function () {
              var t,
                ...
                i = {};
              L.extend(i, this.options.templineStyle),
                this.options.editable && (i.radius = 0),
                null === (t = this._layer) || void 0 === t || t.setStyle(i),
                null === (e = this._hintline) ||
                  void 0 === e ||
                  e.setStyle(this.options.hintlineStyle);
            },
        ...
        function jt(t, e) {
          ...
          if (2 !== i.length)
            throw new Error(
              "<intersects> line1 must only contain 2 coordinates"
            );
          if (2 !== n.length)
            throw new Error(
              "<intersects> line2 must only contain 2 coordinates"
            );
          var r = i[0][0],
            a = i[0][1],
            o = i[1][0],
        ...
        const At = function (t, e) {
          var i = {},
            n = [];
          if (
            ("LineString" === t.type && (t = ot(t)),
            "LineString" === e.type && (e = ot(e)),
            "Feature" === t.type &&
              "Feature" === e.type &&
              null !== t.geometry &&
              null !== e.geometry &&
        ...
        const Gt = function (t, e, i) {
          ...
          var n = Ct(t),
            ...
            h =
              ...
              Math.pow(Math.sin(o / 2), 2) * Math.cos(s) * Math.cos(l);
        ...
        const Ut = function (t, e) {
          ...
          var i = e.precision,
            ...
            r = e.mutate;
          if (
            ((i = i === undefined || null === i || isNaN(i) ? 6 : i),
            (n = n === undefined || null === n || isNaN(n) ? 3 : n),
            !t)
          )
        ...
        function Vt(t, e, i) {
          ...
          var n = Ct(t),
            ...
            u =
              Math.cos(s) * Math.sin(l) -
              Math.sin(s) * Math.cos(l) * Math.cos(o - a);
        ...
        function Kt(t, e, i, n) {
          ...
          var r = Ct(t),
            ...
            l = ct(e, n.units),
            h = Math.asin(
              Math.sin(o) * Math.cos(l) +
                Math.cos(o) * Math.sin(l) * Math.cos(s)
            );
          return st(
            [
              pt(
                a +
                  Math.atan2(
                    Math.sin(s) * Math.sin(l) * Math.cos(o),
                    Math.cos(l) - Math.sin(o) * Math.sin(h)
                  )
              ),
              pt(h),
            ],
        ...
        const Ht = function (t, e, i) {
          void 0 === i && (i = {});
          var n = st([Infinity, Infinity], { dist: Infinity }),
            r = 0;
          return (
            Rt(t, function (t) {
              for (var a = Pt(t), o = 0; o < a.length - 1; o++) {
                ...
                var h = Gt(s, l, i),
                  ...
                  d = Kt(e, u, c - 90, i),
                  f = At(
                    lt([p.geometry.coordinates, d.geometry.coordinates]),
                    lt([s.geometry.coordinates, l.geometry.coordinates])
                  ),
                  g = null;
                f.features.length > 0 &&
                  (((g = f.features[0]).properties.dist = Gt(e, g, i)),
                  (g.properties.location = r + Gt(s, g, i))),
                  s.properties.dist < n.properties.dist &&
                    (((n = s).properties.index = o),
                    (n.properties.location = r)),
                  l.properties.dist < n.properties.dist &&
                    (((n = l).properties.index = o + 1),
                    (n.properties.location = r + h)),
                  g &&
                    g.properties.dist < n.properties.dist &&
                    ((n = g).properties.index = o),
                  (r += h);
              }
            }),
            n
              ...
              if (
                ...
                if (r.features.length) {
                  ...
                  (i = i.filter(function (t) {
                    ...
                    n.remove(a),
                    Dt(Jt(a, e), function (t) {
                      i.push(t), n.insert(t);
                    });
                }
              } else
                (i = Jt(t, e).features).forEach(function (t) {
            ...
            h = (function (t, e, i) {
              ...
              function (t, n, r) {
                var a = Pt(n)[1],
                  o = Ct(e);
                return r === l.id
                  ? (t.push(o), i.push(lt(t)), Xt(o, a) ? [o] : [o, a])
                  : (t.push(a), t);
              },
              [n]
            );
        ...
        function $t(t, e, i) {
          ...
          if (
            ...
            !1 ===
              (function (t, e) {
                return (
                  e[0] <= t[0] && e[1] <= t[1] && e[2] >= t[0] && e[3] >= t[1]
                );
              })(n, o)
          )
            return !1;
          ...
          for (var l = !1, h = 0; h < s.length && !l; h++)
            if (Wt(n, s[h][0], i.ignoreBoundary)) {
              for (var u = !1, c = 1; c < s[h].length && !u; )
                Wt(n, s[h][c], !i.ignoreBoundary) && (u = !0), c++;
              u || (l = !0);
            }
          return l;
        }
          ...
          for (var n = Ct(t), r = Pt(e), a = 0; a < r.length - 1; a++) {
            ...
            if (
              (i.ignoreEndVertices &&
                (0 === a && (o = "start"),
                a === r.length - 2 && (o = "end"),
                0 === a && a + 1 === r.length - 1 && (o = "both")),
              Qt(
                r[a],
                r[a + 1],
                n,
                o,
                "undefined" == typeof i.epsilon ? null : i.epsilon
              ))
            )
              return !0;
          }
        ...
        function ee(t, e) {
          ...
          switch (r) {
                ...
                case "Point":
                  return (function (t, e) {
                    ...
                    for (i = 0; i < t.coordinates.length; i++)
                      if (ne(t.coordinates[i], e.coordinates)) {
                        n = !0;
                        break;
                      }
                    return n;
                ...
                case "MultiPoint":
                  return (function (t, e) {
                    for (var i = 0, n = e.coordinates; i < n.length; i++) {
                      for (
                        var r = n[i], a = !1, o = 0, s = t.coordinates;
                        o < s.length;
                        o++
                      ) {
                        if (ne(r, s[o])) {
            ...
            case "LineString":
              switch (a) {
                case "Point":
                  return te(n, i, { ignoreEndVertices: !0 });
                case "LineString":
                  return (function (t, e) {
                    for (
                      var i = !1, n = 0, r = e.coordinates;
                      n < r.length;
                      n++
                    ) {
                      var a = r[n];
                      if (
                        (te({ type: "Point", coordinates: a }, t, {
                          ignoreEndVertices: !0,
                        }) && (i = !0),
                        !te({ type: "Point", coordinates: a }, t, {
                          ignoreEndVertices: !1,
                ...
                case "MultiPoint":
                  return (function (t, e) {
                    for (
                      ...
                      var a = r[n];
                      if (
                        (te(a, t, { ignoreEndVertices: !0 }) && (i = !0),
                        !te(a, t))
                      )
                        return !1;
                    }
              ...
              switch (a) {
                ...
                case "Polygon":
                  return (function (t, e) {
                    ...
                    if (!ie(i, n)) return !1;
                    for (
                      var r = Et(e).coordinates, a = 0, o = r;
                      a < o.length;
                      a++
                    )
                ...
                case "MultiPoint":
                  return (function (t, e) {
                    for (var i = 0, n = e.coordinates; i < n.length; i++) {
                      if (!$t(n[i], t, { ignoreBoundary: !0 })) return !1;
                    }
                    return !0;
                  })(i, n);
                default:
        ...
        function ue(t) {
          return se({ type: "Polygon", coordinates: t });
        }
        function ce(t) {
          return se({ type: "MultiPolygon", coordinates: t });
        }
        function pe(t) {
          ...
          return (
            i > 1
              ? e.forEach(function (t) {
                  n.push(
                    (function (t) {
                      return se({ type: "LineString", coordinates: t });
                    })(t)
                  );
                })
              : n.push(t),
        ...
        function fe(t) {
          ...
          return (
            ...
            (function (t) {
              return se({ type: "MultiLineString", coordinates: t });
            })(e)
          );
        }
        function ge(t, e) {
          ...
          cut: function (t) {
            ...
            Object.keys(i)
              ...
              .filter(function (t) {
                return (
                  !(
                    ...
                    e.options.layersToCut.length > 0
                  ) || e.options.layersToCut.indexOf(t) > -1
                );
              })
              .filter(function (t) {
              ...
              .filter(function (e) {
                try {
                  var i =
                    !!At(t.toGeoJSON(15), e.toGeoJSON(15)).features.length > 0;
                  return i ||
                    (e instanceof L.Polyline && !(e instanceof L.Polygon))
                    ? i
                    : ((n = t.toGeoJSON(15)),
                      (r = e.toGeoJSON(15)),
                      (a = le(n)),
                      ...
                      !(
                        0 ===
                          (s = oe().intersection(a.coordinates, o.coordinates))
                            .length || !(1 === s.length ? ue(s[0]) : ce(s))
                      ));
                } catch (l) {
                  return (
                    e instanceof L.Polygon &&
                      console.error(
                        "You can't cut polygons with self-intersections"
                      ),
                    !1
                  );
                }
              ...
              .forEach(function (i) {
                  ...
                  n.forEach(function (t) {
                    if (t && t.snapInfo) {
                      ...
                      if (
                        n &&
                        n.segment &&
                        n.distance < e.options.snapDistance
                      ) {
                        var o = n.segment;
                        if (o && 2 === o.length) {
                ...
                if (
                  ...
                  h.getLayers &&
                    0 === h.getLayers().length &&
                    e._map.pm.removeLayer({ target: h }),
          ...
          _cutLayer: function (t, e) {
            ...
            if (e instanceof L.Polygon)
              (n = e.toGeoJSON(15)),
                ...
                (i =
                  0 ===
                  (s = oe().difference(a.coordinates, o.coordinates)).length
                    ? null
                    : 1 === s.length
                    ? ue(s[0])
                    : ce(s));
              ...
              h.forEach(function (e) {
                ...
                (i && i.features.length > 0 ? L.geoJSON(i) : L.geoJSON(e))
                  .getLayers()
                  .forEach(function (e) {
          ...
          (nt.Text = nt.extend({
            ...
            _createMarker: function (t) {
              ...
              if (
                ...
                if (
                  ...
                  null !== (e = this.options.textOptions) &&
                    void 0 !== e &&
                    e.className)
                ) {
                  var n,
                ...
                if (
                  ...
                  (o.pm.textArea = this.textArea),
                    L.setOptions(o.pm, {
                      removeIfEmpty:
                        null ===
                          (s =
                            null === (l = this.options.textOptions) ||
                            void 0 === l
                              ? void 0
                              : l.removeIfEmpty) ||
                        void 0 === s ||
                  ...
                  var p =
                    null ===
                      (h =
                        null === (u = this.options.textOptions) || void 0 === u
                          ? void 0
                          : u.focusAfterDraw) ||
                    void 0 === h ||
                    h;
                  o.pm._createTextMarker(p),
                    null !== (c = this.options.textOptions) &&
                      void 0 !== c &&
                      c.text &&
            ...
            _createTextArea: function () {
              ...
              return (
                (t.autofocus = !0),
                (t.readOnly = !0),
                t.classList.add("pm-textarea", "pm-disabled"),
                t
              );
            },
          ...
          enableLayerDrag: function () {
            if (this.options.draggable && this._layer._map) {
              this.disable(),
                ...
                K(this._layer) instanceof L.Canvas
                ...
                (this._originalMapDragState =
                  this._layer._map.dragging._enabled),
          ...
          _simulateMouseUpEvent: function (t) {
            ...
            return (
              -1 === t.type.indexOf("touch") &&
                ((e.containerPoint = this._map.mouseEventToContainerPoint(t)),
                (e.latlng = this._map.containerPointToLatLng(
                  e.containerPoint
                ))),
              this._dragMixinOnMouseUp(e),
              !1
            );
          },
              ...
              if (L.Util.isArray(this.options.syncLayersOnDrag))
                (n = this.options.syncLayersOnDrag),
                  this.options.syncLayersOnDrag.forEach(function (t) {
                    t instanceof L.LayerGroup &&
                      (n = n.concat(t.pm.getLayers(!0)));
                  });
              else if (
                !0 === this.options.syncLayersOnDrag &&
        ...
        var Me = {
          _onRotateStart: function (t) {
            this._preventRenderingMarkers(!0),
              ...
              (this._rotationOriginPoint = be(
                this._map,
                this._rotationOriginLatLng
              )),
              (this._rotationStartPoint = be(this._map, t.target.getLatLng())),
          ...
          _rotateLayer: function (t, e, i, n, r) {
            var a = be(r, i);
            return (
              (this._matrix = n.clone().rotate(t, a).flip()),
              Le(e, this._matrix, r)
            );
          },
        ...
        const we = L.Class.extend({
          ...
          _vertexValidation: function (t, e) {
            ...
            return (
              "move" === t
                ? (r = "moveVertexValidation")
                : "add" === t
                ? (r = "addVertexValidation")
                : "remove" === t && (r = "removeVertexValidation"),
              this.options[r] &&
              "function" == typeof this.options[r] &&
              !this.options[r](n)
                ? ("move" === t && (i._cancelDragEventChain = i.getLatLng()),
                  !1)
                ...
                function (t) {
                  if (!t.layer._pmTempLayer) {
                    ...
                    var i = e._layers.filter(function (t) {
                      return (
                        !t.pm._parentLayerGroup ||
                        !(e._layerGroup._leaflet_id in t.pm._parentLayerGroup)
                      );
                    });
                    i.forEach(function (t) {
                      e._initLayer(t);
                      ...
                      i.length > 0 &&
                        e._getMap() &&
                        e._getMap().pm.globalEditModeEnabled() &&
                        e.enabled() &&
                        e.enable(e.getOptions());
                  }
                },
                100,
                this
          ...
          enabled: function () {
            ...
            var e = this._layers.find(function (e) {
              return e instanceof L.LayerGroup
                ? -1 === t.indexOf(e._leaflet_id) &&
                    (t.push(e._leaflet_id), e.pm.enabled(t))
                : e.pm.enabled();
            });
            return !!e;
          },
            ...
            return (
              t
                ? this._layerGroup.getLayers().forEach(function (t) {
                    r.push(t),
                      t instanceof L.LayerGroup &&
                        -1 === n.indexOf(t._leaflet_id) &&
                        (n.push(t._leaflet_id),
                        (r = r.concat(t.pm.getLayers(!0, !0, !0, n))));
                  })
        ...
        const Ee = {
          ...
          createCache: function () {
            var t = [].concat(
              Ce(this._markerGroup.getLayers()),
              Ce(this.markerCache)
            );
          ...
          renderLimits: function (t) {
            ...
            this.markerCache.forEach(function (i) {
              t.includes(i)
                ? e._markerGroup.addLayer(i)
                : e._markerGroup.removeLayer(i);
            });
          },
        ...
        (we.Line = we.extend({
                ...
                (this.options.allowEditing
                  ? (this.enabled() && this.disable(),
                    ...
                    this.options.allowSelfIntersection
                      ...
                      : ("#f00000ff" !== this._layer.options.color
            ...
            if (this.enabled() && !this._dragging) {
              ...
              L.DomUtil.removeClass(t, "leaflet-pm-draggable"),
                (this._map.hasLayer(this._layer) &&
                  ...
                  L.DomUtil.removeClass(t, "leaflet-pm-invalid"),
                this._layerEdited && this._fireUpdate(),
                (this._layerEdited = !1),
                this._fireDisable();
            }
          ...
          _createMiddleMarker: function (t, e) {
            if (!t || !e) return !1;
            var i = L.PM.Utils.calcMiddleLatLng(
                this._map,
                t.getLatLng(),
                e.getLatLng()
              ),
          ...
          _handleLayerStyle: function (t) {
            ...
            if (this.hasSelfIntersection()) {
              ...
              t
                ...
                this._fireIntersect(gt(this._layer.toGeoJSON(15)));
            } else
          ...
          _updateDisabledMarkerStyle: function (t, e) {
            ...
            t.forEach(function (t) {
              Array.isArray(t)
                ...
                : t._icon &&
                  (e && !i._checkMarkerAllowedToDrag(t)
            ...
            if (this._vertexValidation("remove", t)) {
              ...
              if (r) {
                ...
                if (
                  ...
                  !(s.length <= 2 || (this.isPolygon() && s.length <= 3))
                ) {
                  s.splice(a, 1),
                    this._layer.setLatLngs(i),
                    this.isPolygon() && s.length <= 2 && s.splice(0, s.length);
                  var h = !1;
                  if (
                    (s.length <= 1 &&
                      (s.splice(0, s.length),
                      o.length > 1 && r.length > 1 && (i = A(i)),
                      this._layer.setLatLngs(i),
                      this._initMarkers(),
                      (h = !0)),
                    j(i) || this._layer.remove(),
                    (i = A(i)),
                    this._layer.setLatLngs(i),
                    (this._markers = A(this._markers)),
                    !h &&
                      ((l =
                        r.length > 1 ? B()(this._markers, o) : this._markers),
                      e._middleMarkerPrev &&
                    ...
                    if (
                      (this.isPolygon()
                        ? ((u = (a + 1) % l.length),
                          (c = (a + (l.length - 1)) % l.length))
                        : ((c = a - 1 < 0 ? undefined : a - 1),
                          (u = a + 1 >= l.length ? undefined : a + 1)),
                      u !== c)
                    ) {
                      var p = l[c],
                        d = l[u];
                      !0 !== this.options.hideMiddleMarkers &&
                        this._createMiddleMarker(p, d);
                    }
                    l.splice(a, 1);
                  }
                  this._fireEdit(),
          ...
          updatePolygonCoordsFromMarkerDrag: function (t) {
            var e = this._layer.getLatLngs(),
              ...
              a = n.index,
              o = n.parentPath;
            (r.length > 1 ? B()(e, o) : e).splice(a, 1, i),
              this._layer.setLatLngs(e);
          },
          ...
          _checkMarkerAllowedToDrag: function (t) {
            var e = this._getNeighborMarkers(t),
              ...
              o = At(this._layer.toGeoJSON(15), r.toGeoJSON(15)).features
                .length,
              s = At(this._layer.toGeoJSON(15), a.toGeoJSON(15)).features
                .length;
            return (
          ...
          _onMarkerDragStart: function (t) {
            ...
            if (
              ...
              var i = L.PM.Utils.findDeepMarkerIndex(
                this._markers,
                e
              ).indexPath;
              this._fireMarkerDragStart(t, i),
                ...
                this.hasSelfIntersection()
                  ? (this._markerAllowedToDrag =
                      this._checkMarkerAllowedToDrag(e))
          ...
          (we.Rectangle = we.Polygon.extend({
            ...
            _addMarkerEvents: function () {
              ...
              this._markers[0].forEach(function (e) {
                e.on("dragstart", t._onMarkerDragStart, t),
                  e.on("drag", t._onMarkerDrag, t),
                  e.on("dragend", t._onMarkerDragEnd, t),
                  t.options.preventMarkerRemoval ||
                    e.on("contextmenu", t._removeMarker, t);
              });
            },
            ...
            _adjustRectangleForMarkerMove: function (t) {
              ...
              var e = L.PM.Utils._getRotatedRectangle(
                t.getLatLng(),
          ...
          (we.Circle = we.extend({
            ...
            _resizeCircle: function () {
              this._outerMarker.setLatLng(
                this._getNewDestinationOfOuterMarker()
              ),
                this._syncHintLine(),
            ...
            _onCircleDragStart: function (t) {
              this._vertexValidationDrag(t.target)
                ? (delete this._vertexValidationReset, this._fireDragStart())
                : (this._vertexValidationReset = !0);
            },
            _onCircleDrag: function (t) {
              this._vertexValidationReset || this._fireDrag(t);
            },
            _onCircleDragEnd: function () {
              this._vertexValidationReset
            ...
            _getNewDestinationOfOuterMarker: function () {
              ...
              return (
                this.options.minRadiusCircle && i < this.options.minRadiusCircle
                  ...
                  : this.options.maxRadiusCircle &&
                    i > this.options.maxRadiusCircle &&
                    (e = z(this._map, t, e, this.options.maxRadiusCircle)),
                e
              );
            },
          ...
          (we.CircleMarker = we.extend({
            ...
            _updateHiddenPolyCircle: function () {
              ...
              if (t) {
                var e = L.PM.Utils.pxRadiusToMeterRadius(
                ...
                this._hiddenPolyCircle
                  ? this._hiddenPolyCircle.setLatLngs(
                      L.PM.Utils.circleToPolygon(i, 200, !n).getLatLngs()
                    )
                  : (this._hiddenPolyCircle = L.PM.Utils.circleToPolygon(
                      i,
                      200,
          ...
          (we.Text = we.extend({
            ...
            _autoResize: function () {
              ...
              var t =
                  this.textArea.scrollHeight > 21
                    ? this.textArea.scrollHeight
                    : 21,
                e =
                  this.textArea.scrollWidth > 16
                    ? this.textArea.scrollWidth
                    : 16;
              (this.textArea.style.height = "".concat(t, "px")),
                (this.textArea.style.width = "".concat(e, "px")),
            ...
            _disableOnBlur: function () {
              ...
              (this._disableOnBlurActive = !0),
                setTimeout(function () {
                  t.enabled() &&
                    L.DomEvent.on(document, "click", t._documentClick, t);
                }, 100);
            },
            ...
            _initTextMarker: function () {
              if (
                ((this.textArea =
                  L.PM.Draw.Text.prototype._createTextArea.call(this)),
              ...
              var i = L.PM.Draw.Text.prototype._createTextIcon.call(
                this,
                this.textArea
              );
              this._layer.setIcon(i),
            ...
            _createTextMarker: function () {
              ...
              this._layer.off("add", this._createTextMarker, this),
                ...
                (this.textArea.style.width = "1px"),
                this._layer.options.text &&
                  this.setText(this._layer.options.text),
                this._autoResize(),
                !0 === t &&
                  (this.enable(), this.focus(), this._disableOnBlur());
            },
        ...
        (Re.init = function () {
          ...
          (Re.prototype = {
            ...
            translate: function (t) {
              return t === undefined
                ? new L.Point(this._matrix[4], this._matrix[5])
                : ("number" == typeof t
                    ? ((e = t), (i = t))
                    : ((e = t.x), (i = t.y)),
              ...
              return t === undefined
                ...
                : ((e = e || L.point(0, 0)),
                  "number" == typeof t
                    ? ((i = t), (n = t))
                    : ((i = t.x), (n = t.y)),
                  this._add(i, 0, 0, n, e.x, e.y)._add(1, 0, 0, 1, -e.x, -e.y));
              var i, n;
            },
            rotate: function (t, e) {
              var i = Math.cos(t),
              ...
              return (
                (e = e || new L.Point(0, 0)),
                this._add(i, n, -n, i, e.x, e.y)._add(1, 0, 0, 1, -e.x, -e.y)
              );
            },
            flip: function () {
        ...
        var Ie = {
          ...
          disablePopup: function (t) {
            t.getPopup() &&
              ((t._tempPopupCopy = t.getPopup()), t.unbindPopup());
          },
            ...
            var i,
              ...
              r = function o(t) {
                return function (r, a) {
                  var s = t.concat(a);
                  if (n) {
                    if (r.lat && r.lat === e.lat && r.lng === e.lng)
                      return (i = s), !0;
          ...
          findDeepMarkerIndex: function (t, e) {
            ...
            t.some(
              (function r(t) {
                return function (n, a) {
                  var o = t.concat(a);
                  return n._leaflet_id === e._leaflet_id
                    ? ((i = o), !0)
                    : Array.isArray(n) && n.some(r(o));
                };
              })([])
            );
            var n = {};
                    ...
                    ? !1 === this.options.pmIgnore &&
                      (this.options.textMarker
                        ? ((this.pm = new L.PM.Edit.Text(this)),
                          this.options._textMarkerOverPM ||
      ...
      7107: () => {
        (Array.prototype.findIndex =
          ...
          function (t) {
            ...
            for (
              var e = Object(this), i = e.length >>> 0, n = arguments[1], r = 0;
              r < i;
              r++
            )
      ...
      4865: (t, e, i) => {
        ...
        t.exports = function (t, e, i) {
          var o = t[e];
          (a.call(t, e) && r(o, i) && (i !== undefined || e in t)) ||
            n(t, e, i);
        };
      },
      8470: (t, e, i) => {
      ...
      7786: (t, e, i) => {
        var n = i(1811),
          r = i(327);
        t.exports = function (t, e) {
          for (var i = 0, a = (e = n(e, t)).length; null != t && i < a; )
            t = t[r(e[i++])];
      ...
      313: (t, e, i) => {
        ...
        t.exports = function (t) {
          ...
          var e = r(t),
            i = [];
          for (var s in t)
            ("constructor" != s || (!e && o.call(t, s))) && i.push(s);
          return i;
        };
      },
      2980: (t, e, i) => {
        ...
        t.exports = function (t) {
          return n(function (e, i) {
            var n = -1,
              ...
              s = a > 2 ? i[2] : undefined;
            for (
              o = t.length > 3 && "function" == typeof o ? (a--, o) : undefined,
                s && r(i[0], i[1], s) && ((o = a < 3 ? undefined : o), (a = 1)),
                e = Object(e);
              ++n < a;
      ...
      1866: (t, e, i) => {
        ...
        t.exports = function (t, e) {
          ...
          return (
            ...
            (i[t] = n && e === undefined ? "__lodash_hash_undefined__" : e),
            this
          );
        };
      },
      ...
      5357: (t, e, i) => {
        ...
        t.exports = function (t, e, i) {
          return (
            ...
            function () {
              for (
                var a = arguments, o = -1, s = r(a.length - e, 0), l = Array(s);
                ++o < s;
      ...
      2676: function (t) {
        t.exports = (function () {
          ...
          function o(t, e, i, r) {
            ...
            return (
              s < 0
                ...
                : s >= 0 &&
                  ((o.right = i.right), (o.left = i), (i.right = null)),
              o
            );
          }
          function s(t, e, i) {
          ...
          function l(t, e, i) {
            return null === e
              ? t
              : (null === t || ((e = a(t.key, e, i)).left = t), e);
          }
          function h(t, e, i, n, r) {
            if (t) {
              n(e + (i ? "└── " : "├── ") + r(t) + "\n");
              var a = e + (i ? "    " : "│   ");
              t.left && h(t.left, a, !1, n, r),
                t.right && h(t.right, a, !0, n, r);
            }
          }
          var u = (function () {
            function t(t) {
            ...
            return (
              (t.prototype.insert = function (t, e) {
                return (
                  this._size++,
                  (this._root = o(t, e, this._root, this._comparator))
                );
              }),
                ...
                return (
                  0 === s
                    ...
                    : (s < 0
                        ...
                        : s > 0 &&
                          ((i.right = o.right), (i.left = o), (o.right = null)),
                      this._size++,
                      (this._root = i)),
                  this._root
                );
              ...
              (t.prototype.range = function (t, e, i, n) {
                for (
                  var r = [], a = this._comparator, o = this._root;
                  0 !== r.length || o;
              ...
              (t.prototype.load = function (t, e, i) {
                ...
                var n = t.length,
                  r = this._comparator;
                if ((i && _(t, e, 0, n - 1, r), null === this._root))
                  (this._root = c(t, e, 0, n)), (this._size = n);
                else {
              ...
              (t.prototype.update = function (t, e, i) {
                var n = this._comparator,
                  ...
                  a = r.left,
                  h = r.right;
                n(t, e) < 0 ? (h = o(e, i, h, n)) : (a = o(e, i, a, n)),
                  (this._root = l(a, h, n));
              }),
          ...
          function p(t, e) {
            for (var i = new n(null, null), r = i, a = 0; a < t.length; a++)
              r = r.next = new n(t[a], e[a]);
            return (r.next = null), i.next;
          }
          function d(t) {
            for (var e = t, i = [], r = !1, a = new n(null, null), o = a; !r; )
              e
                ? (i.push(e), (e = e.left))
                : i.length > 0
          ...
          function g(t, e, i) {
            for (
              var r = new n(null, null), a = r, o = t, s = e;
              null !== o && null !== s;
              ...
              i(o.key, s.key) < 0
                ...
                (a = a.next);
            return (
              null !== o ? (a.next = o) : null !== s && (a.next = s), r.next
            );
          }
          ...
          var L = v * v,
                ...
                i(e, [
                  {
                    ...
                    value: function (t) {
                      var e = this.tree.add(t),
                        i = this.tree.prev(e);
                      if (null !== i && 0 === b(e.key, i.key))
                        return this.tree.remove(t), i.key;
                      var n = this.tree.next(e);
                      return null !== n && 0 === b(e.key, n.key)
            ...
            D = function (t, e, i) {
              return 0 === e.y
                ? null
                : { x: t.x + (e.x / e.y) * (i - t.y), y: i };
            },
            B = function (t, e, i) {
              return 0 === e.x
                ? null
                : { x: i, y: t.y + (e.y / e.x) * (i - t.x) };
            },
            R = function (t, e, i, n) {
                ...
                i(e, null, [
                  {
                    ...
                    value: function (t, i) {
                      ...
                      return 0 !== n
                        ? n
                        : (t.point !== i.point && t.link(i),
                          t.isLeft !== i.isLeft
                            ? t.isLeft
                              ? 1
                              : -1
                            : j.compare(t.segment, i.segment));
                    },
                  },
                  {
                    key: "comparePoints",
                ...
                i(e, [
                  {
                    ...
                    value: function (t) {
                      ...
                      for (
                        var e = t.point.events, i = 0, n = e.length;
                        i < n;
                        i++
                      ) {
                        var r = e[i];
                  ...
                  },
                  {
                    ...
                    value: function () {
                      for (
                        var t = [], e = 0, i = this.point.events.length;
                        e < i;
                        e++
                      ) {
                  ...
                  [
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        if (h)
                          return u && r.x === s.x && r.y === s.y ? null : r;
                        if (l)
                          return c && a.x === o.x && a.y === o.y ? null : o;
                        if (c && u) return null;
                        if (c) return a;
                        if (u) return s;
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        return (
                          T.comparePoints(s.leftSE.point, s.rightSE.point) >
                            0 && s.swapEvents(),
                          T.comparePoints(
                            this.leftSE.point,
                            this.rightSE.point
                    ...
                    },
                    {
                      key: "consume",
                      value: function (t) {
                        for (var i = this, n = t; i.consumedBy; )
                          i = i.consumedBy;
                        ...
                        if (0 !== r) {
                          ...
                          for (var s = 0, l = n.rings.length; s < l; s++) {
                            var h = n.rings[s],
                              ...
                              c = i.rings.indexOf(h);
                            -1 === c
                              ? (i.rings.push(h), i.windings.push(u))
                              : (i.windings[c] += u);
                          }
                          (n.rings = null),
                            (n.windings = null),
                      ...
                      value: function () {
                        ...
                        switch (q.type) {
                          ...
                          case "intersection":
                            var r, a;
                            t.length < e.length
                              ? ((r = t.length), (a = e.length))
                              : ((r = e.length), (a = t.length)),
                              (this._isInResult =
                                a === q.numMultiPolys && r < a);
                            break;
                          case "xor":
            ...
            A = (function () {
              function e(i, n, r) {
                if ((t(this, e), !Array.isArray(i) || 0 === i.length))
                  throw new Error(
                ...
                if (
                  ...
                  (this.isExterior = r),
                  (this.segments = []),
                  "number" != typeof i[0][0] || "number" != typeof i[0][1])
                )
                  throw new Error(
                    "Input geometry is not a valid Polygon or MultiPolygon"
                  );
                ...
                for (var o = a, s = 1, l = i.length; s < l; s++) {
                  if ("number" != typeof i[s][0] || "number" != typeof i[s][1])
                    throw new Error(
                      "Input geometry is not a valid Polygon or MultiPolygon"
                    );
                ...
                (a.x === o.x && a.y === o.y) ||
                  this.segments.push(j.fromRing(o, a, this));
              }
              return (
                i(e, [
                  {
            ...
            G = (function () {
              function e(i, n) {
                if ((t(this, e), !Array.isArray(i)))
                  throw new Error(
                    "Input geometry is not a valid Polygon or MultiPolygon"
                  );
                (this.exteriorRing = new A(i[0], this, !0)),
                  (this.bbox = {
                    ll: {
                ...
                for (var r = 1, a = i.length; r < a; r++) {
                  ...
                  o.bbox.ll.x < this.bbox.ll.x &&
                    (this.bbox.ll.x = o.bbox.ll.x),
                    o.bbox.ll.y < this.bbox.ll.y &&
                      (this.bbox.ll.y = o.bbox.ll.y),
                    o.bbox.ur.x > this.bbox.ur.x &&
                      (this.bbox.ur.x = o.bbox.ur.x),
                    o.bbox.ur.y > this.bbox.ur.y &&
                      (this.bbox.ur.y = o.bbox.ur.y),
                        ...
                        if (a.isInResult() && !a.ringOut) {
                          for (
                            ...
                            for (;;) {
                              ...
                              var v = c.splice(g)[0],
                                L = h.splice(v.index);
                              L.unshift(L[0].otherSE),
                                i.push(new e(L.reverse()));
                            }
                          i.push(new e(h));
                        }
                      }
                ...
                i(e, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      for (
                        var r = t.segment.prevInResult(),
                          a = r ? r.prevInResult() : null;
                        ;

                      ) {
                        if (!r) return null;
                        if (!a) return r.ringOut;
                        if (a.ringOut !== r.ringOut)
                          return a.ringOut.enclosingRing() !== r.ringOut
                            ? r.ringOut
                ...
                i(e, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      for (
                        var e = 0, i = this.interiorRings.length;
                        e < i;
                        e++
                      ) {
            ...
            U = (function () {
              function e(i) {
                t(this, e),
                  (this.rings = i),
                  (this.polys = this._composePolys(i));
              }
              return (
                i(e, [
                  {
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      for (var e = [], i = 0, n = t.length; i < n; i++) {
                        var r = t[i];
                        if (!r.poly)
                          if (r.isExteriorRing()) e.push(new F(r));
                          else {
                ...
                i(e, [
                  {
                    ...
                    value: function (t) {
                      ...
                      for (
                        var r = n, a = n, o = undefined, s = undefined;
                        o === undefined;

                      )
                        null === (r = this.tree.prev(r))
                          ? (o = null)
                          : r.key.consumedBy === undefined && (o = r.key);
                      for (; s === undefined; )
                        null === (a = this.tree.next(a))
                          ? (s = null)
                          : a.key.consumedBy === undefined && (s = a.key);
                      if (t.isLeft) {
                        var l = null;
                        if (o) {
                          ...
                          if (
                            null !== h &&
                            (e.isAnEndpoint(h) || (l = h), !o.isAnEndpoint(h))
                          )
                            for (
                              var u = this._splitSafely(o, h),
                                c = 0,
                                p = u.length;
                              c < p;
                              c++
                        ...
                        if (null !== l || null !== d) {
                          ...
                          (y =
                            null === l
                              ? d
                              : null === d || T.comparePoints(l, d) <= 0
                              ? l
                              : d),
                            this.queue.remove(e.rightSE),
                            i.push(e.rightSE);
                          for (
                            var v = e.split(y), L = 0, b = v.length;
                            L < b;
                            L++
                          )
                            i.push(v[L]);
                  ...
                  },
                  {
                    ...
                    value: function (t, e) {
                      ...
                      return (
                        n.push(i),
                        t.consumedBy === undefined && this.tree.insert(t),
                        n
                      );
                    },
                  },
                ...
                i(e, [
                  {
                    ...
                    value: function (t, e, i) {
                      (q.type = t), x.reset();
                      for (
                        var n = [new N(e, !0)], r = 0, a = i.length;
                        r < a;
                        r++
                      )
                        n.push(new N(i[r], !1));
                      if (
                        ((q.numMultiPolys = n.length), "difference" === q.type)
                      )
                        for (var o = n[0], s = 1; s < n.length; )
                          null !== y(n[s].bbox, o.bbox) ? s++ : n.splice(s, 1);
                      if ("intersection" === q.type)
                        for (var l = 0, h = n.length; l < h; l++)
                          for (
                            var c = n[l], p = l + 1, d = n.length;
                            p < d;
                            p++
                          )
                            if (null === y(c.bbox, n[p].bbox)) return [];
                      for (
                        var f = new u(T.compare), g = 0, _ = n.length;
                        g < _;
                        g++
                      )
                        for (
                          var m = n[g].getSweepEvents(), v = 0, L = m.length;
                          v < L;
                          v++
                        )
                          if ((f.insert(m[v]), f.size > K))
                            throw new Error(
        ...
        t.exports = (function () {
              ...
              for (; r > n; ) {
                if (r - n > 600) {
                  ...
                  s(
                    t,
                    i,
                    Math.max(n, Math.floor(i - (l * u) / o + c)),
                    Math.min(r, Math.floor(i + ((o - l) * u) / o + c)),
                    a
                  );
                }
                var p = t[i],
          ...
          return (
            ...
            (n.prototype.remove = function (t, e) {
              if (!t) return this;
              for (
                var i, n, a, o = this.data, s = this.toBBox(t), l = [], h = [];
                o || l.length;
            ...
            (n.prototype._chooseSplitIndex = function (t, e, i) {
              for (
                var n, r, a, s, l, h, c, p = 1 / 0, d = 1 / 0, f = e;
                f <= i - e;
                f++
              ) {
            ...
            (n.prototype._chooseSplitAxis = function (t, e, i) {
              ...
              this._allDistMargin(t, e, i, n) <
                this._allDistMargin(t, e, i, r) && t.children.sort(n);
            }),
