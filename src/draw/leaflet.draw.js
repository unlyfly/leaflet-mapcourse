      ...
      _endPoint: function (e, i, o) {
        if (this._mouseDownOrigin) {
          ...
          this.options.maxPoints == this._markers.length + 1
            ...
            ? this._finishShape()
            : Math.abs(a) < 9 * (t.devicePixelRatio || 1) &&
      ...
      _getTooltipText: function () {
        ...
        return (
          a &&
            ...
            (i = n ? L.GeometryUtil.readableArea(e, this.options.metric) : "")),
            ...
            for (var s = 0; s < o; s++)
              (e = t[s]),
                ...
                (a +=
                  (i.lng - e.lng) *
                  n *
                  (2 + Math.sin(e.lat * n) + Math.sin(i.lat * n)));
        ...
        readableDistance: function (e, i, o, a, n) {
          ...
          switch (
            ...
            case "metric":
              s =
                e > 1e3
                  ? L.GeometryUtil.formattedNumber(e / 1e3, n.km) + " km"
                  : L.GeometryUtil.formattedNumber(e, n.m) + " m";
              break;
            case "feet":
              (e *= 3.28083),
            ...
            default:
              (e *= 1.09361),
                (s =
                  e > 1760
                    ? L.GeometryUtil.formattedNumber(e / 1760, n.mi) + " miles"
                    : L.GeometryUtil.formattedNumber(e, n.yd) + " yd");
          }
          return s;
        },
    ...
    L.Polyline.include({
      ...
      newPointIntersects: function (t, e) {
        ...
        return (
          ...
          this._lineSegmentsIntersectsRange(a, t, n, e ? 1 : 0)
        );
      },
      ...
      _lineSegmentsIntersectsRange: function (t, e, i, o) {
        ...
        for (var r = i; r > o; r--)
          if (
            ((a = s[r - 1]),
            (n = s[r]),
            L.LineUtil.segmentsIntersect(t, e, a, n))
          )
            return !0;
        return !1;
      },
